...
namespace GateKernels
{
    ...
    inline void apply_c1_gate_omp(const ValType *gm_real,
...
#pragma omp for schedule(auto)
    ...
    inline void apply_c2_gate_omp(const ValType *gm_real,
                                  const ValType *gm_imag,
                                  IdxType qubit0,
                                  IdxType qubit1,
                                  ValType *state_real,
...
#pragma omp for schedule(auto)
    ...
    inline void apply_c4_gate_omp(const ValType *gm_real,
                                  const ValType *gm_imag,
                                  IdxType qubit0,
                                  IdxType qubit1,
                                  IdxType qubit2,
...
#pragma omp for schedule(auto)
    ...
    inline IdxType measure_qubit_omp(IdxType n_qubits,
                                     IdxType qubit,
                                     ValType *state_real,
                                     ValType *state_imag,
                                     ValType *scratch,
...
#pragma omp barrier
    ...
    inline void measure_all_omp(IdxType n_qubits,
                                IdxType repetition,
                                ValType *state_real,
                                ValType *state_imag,
                                ValType *scratch,
...
#pragma omp barrier
    ...
    inline void reset_qubit_omp(IdxType n_qubits,
                                IdxType qubit,
                                ValType *state_real,
                                ValType *state_imag,
                                ValType *scratch)
...
#pragma omp barrier
    ...
    inline ValType expectation_mask_omp(IdxType n_qubits,
                                        IdxType mask,
...
#pragma omp barrier
    ...
    inline ValType expectation_observable_omp(IdxType n_qubits,
                                              ...
                                              const ValType *state_imag)
    {
        ...
        {
            result += terms[t].coeff * expectation_mask_omp(n_qubits, terms[t].mask, state_real, state_imag);
        }
        return result;
    }
