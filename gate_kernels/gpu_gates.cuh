...
{
    constexpr ValType MEASUREMENT_ERROR_BAR = 1e-3;
    ...
    __device__ __forceinline__ void apply_c1_gate_gpu(const ValType *gm_real,
    ...
    __device__ __forceinline__ void apply_c2_gate_gpu(const ValType *gm_real,
                                                       const ValType *gm_imag,
                                                       IdxType qubit0,
                                                       IdxType qubit1,
                                                       ValType *state_real,
    ...
    __device__ __forceinline__ void apply_c4_gate_gpu(const ValType *gm_real,
                                                       const ValType *gm_imag,
                                                       IdxType qubit0,
                                                       IdxType qubit1,
                                                       IdxType qubit2,
    ...
    __device__ __forceinline__ void measure_qubit_gpu(IdxType n_qubits,
                                                       IdxType qubit,
                                                       ValType *state_real,
                                                       ValType *state_imag,
                                                       ValType *prob_buffer,
    ...
    __device__ __forceinline__ void measure_all_gpu(IdxType n_qubits,
                                                     IdxType repetition,
                                                     ValType *state_real,
                                                     ValType *state_imag,
    ...
    __device__ __forceinline__ void reset_qubit_gpu(IdxType n_qubits,
                                                    IdxType qubit,
                                                    ValType *state_real,
                                                    ValType *state_imag,
                                                    ValType *workspace)
    ...
    __device__ __forceinline__ void expectation_mask_gpu(IdxType n_qubits,
                                                             IdxType mask,
                                                             ValType coeff,
    ...
    __device__ __forceinline__ ValType compute_expectation_observable_gpu(IdxType n_qubits,
                                                                          ...
                                                                          ValType *workspace)
    {
        ...
        {
            expectation_mask_gpu(n_qubits, terms[t].mask, terms[t].coeff,
    ...
    __device__ __forceinline__ void expectation_observable_gpu(IdxType n_qubits,
                                                               const ZObservableTerm *terms,
                                                               IdxType term_count,
                                                               const ValType *state_real,
                                                               const ValType *state_imag,
                                                               ...
                                                               ValType *result_ptr)
    {
        ValType value = compute_expectation_observable_gpu(n_qubits, terms, term_count,
                                                           state_real, state_imag, workspace);
