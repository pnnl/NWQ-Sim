...
namespace GateKernels
{
    ...
    inline void apply_c1_gate_cpu(const ValType *gm_real,
    ...
    inline void apply_c2_gate_cpu(const ValType *gm_real,
                                  const ValType *gm_imag,
                                  IdxType qubit0,
                                  IdxType qubit1,
                                  ValType *state_real,
    ...
    inline void apply_c4_gate_cpu(const ValType *gm_real,
                                  const ValType *gm_imag,
                                  IdxType qubit0,
                                  IdxType qubit1,
                                  IdxType qubit2,
    ...
    inline IdxType measure_qubit_cpu(IdxType n_qubits,
                                     IdxType qubit,
                                     ValType *state_real,
                                     ValType *state_imag,
    ...
    inline void measure_all_cpu(IdxType n_qubits,
                                IdxType repetition,
                                ValType *state_real,
                                ValType *state_imag,
    ...
    inline void reset_qubit_cpu(IdxType n_qubits,
                                IdxType qubit,
                                ValType *state_real,
                                ValType *state_imag)
    {
    ...
    inline ValType expectation_mask_cpu(IdxType n_qubits,
                                        IdxType mask,
    ...
    inline ValType expectation_observable_cpu(IdxType n_qubits,
                                              ...
                                              const ValType *state_imag)
    {
        ...
        {
            result += terms[t].coeff * expectation_mask_cpu(n_qubits, terms[t].mask, state_real, state_imag);
        }
        return result;
    }
