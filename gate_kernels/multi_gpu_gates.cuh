...
namespace GateKernels
{
    ...
    __device__ __forceinline__ void measure_qubit_multi(const NvshmemState &state,
                                                         IdxType n_qubits,
                                                         IdxType qubit,
    ...
    __device__ __forceinline__ void measure_all_multi(const NvshmemState &state,
                                                       IdxType n_qubits,
                                                       IdxType repetition,
                                                       ValType *probabilities,
                                                       IdxType *results,
    ...
    __device__ __forceinline__ void reset_qubit_multi(const NvshmemState &state,
                                                      IdxType n_qubits,
                                                      IdxType qubit,
                                                      ValType *probabilities)
    {
    ...
    __device__ __forceinline__ void expectation_mask_multi(const NvshmemState &state,
                                                               IdxType n_qubits,
                                                               IdxType mask,
                                                               ValType coeff,
                                                               ValType *workspace)
    ...
    __device__ __forceinline__ void expectation_observable_multi(const NvshmemState &state,
                                                                  IdxType n_qubits,
                                                                  ...
                                                                  ValType *result_ptr)
    {
        ...
        {
            expectation_mask_multi(state, n_qubits, terms[t].mask, terms[t].coeff, workspace);
            grid.sync();
        }
