...
"""Backend for the SV-Sim GPU simulation environment."""
...
class SVSimWrapper:
    """Converter to and from SVSim_gpu simulator"""
    ...
    def __init__(self, qobj, shell):
        ...
        self.sim = svsim.Simulation(self.n_qubits)
    ...
    def run_experiment(self, experiment):
        ...
        #self.end_time = time.time()
        #print("Result formatting time is:" + str(self.end_time - self.start_time))
        return result_dict
...
#======================================== SVSim Simulator ================================
class SVSimGpuSimulator(Backend):
    """Python interface to NWQSim's SVSim gpu simulator"""
    ...
    default_configuration = {
        ...
        'memory': True,
        'max_shots': 100000,
        'description': 'NWQSim state vector simulator with NVIDIA GPU cluster backend',
        'gates': []
    }
    ...
    def _run_job(self, job_id, qc):
        ...
        #print("Prepare time is:" + str(end-start))
