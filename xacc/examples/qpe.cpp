...
int main(int argc, char **argv)
{
    ...
    auto derivedPtr = std::make_shared<xacc::quantum::NWQAccelerator>();
    auto acc = std::static_pointer_cast<xacc::Accelerator>(derivedPtr);

    // auto acc = xacc::quantum::NWQAccelerator();
    // acc.updateConfiguration({std::make_pair("shots", 4096)});
