#include "../nwq_api.hpp"
#include "../../cluster/svsim/src/util.h"
#include "../../cluster/svsim/src/svsim_nvgpu_mpi.cuh"
...
namespace NWQSim
{
    class NWQBackendSVNVGPUMPI : public NWQBackend
    {
    public:
    ...
    {
        return std::make_shared<NWQBackendSVNVGPUMPI>();
    }
