...
#include "../include/svsim/sv_nvgpu.cuh" // derived class for state
/**************************************************************************/
...
int main(int argc, char **argv)
{
    ...
    if (cmdOptionExists(argv, argv + argc, "--app"))
    {
        ...
        QuantumState *state = new SV_NVGPU(parser.num_qubits());
    ...
    if (cmdOptionExists(argv, argv + argc, "-t"))
    {
        ...
        auto fidelity = run_brnchmark(benchmark_index, total_shots, run_with_basis);
