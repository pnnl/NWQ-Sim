...
namespace NWQSim
{
    ...
    void gate_fusion_2q(const std::vector<Gate> &circuit_in, std::vector<Gate> &circuit_out, const IdxType n_qubits)
    {
        ...
        for (size_t i = 0; i < circuit_in.size(); i++)
        {
            ...
            else if (circuit_in[i].n_qubits == 1) // 1-qubit gate
            {
                IdxType qubit = circuit_in[i].qubit;
                Gate g(circuit_in[i]);
                for (IdxType j = 0; j < n_qubits; j++)
            ...
            else if (circuit_in[i].n_qubits == 2) // 2-qubit gate
            {
                IdxType qubit = circuit_in[i].qubit;
    ...
    void gate_fusion_1q(const std::vector<Gate> &circuit_in, std::vector<Gate> &circuit_out, const IdxType n_qubits)
    {
        // prepare
    ...
    void gate_fusion_2q_absorb_1q_forward(const std::vector<Gate> &circuit_in, std::vector<Gate> &circuit_out, const IdxType n_qubits)
    {
        // prepare
        IdxType *table = new IdxType[n_qubits * n_qubits];
        bool *canfuse = new bool[n_qubits * n_qubits];
    ...
    void gate_fusion_2q_absorb_1q_backward(const std::vector<Gate> &circuit_in, std::vector<Gate> &circuit_out, const IdxType n_qubits)
    {
        // prepare
        IdxType *table = new IdxType[n_qubits * n_qubits];
        bool *canfuse = new bool[n_qubits * n_qubits];
        ...
        for (IdxType i = circuit_in.size() - 1; i >= 0; i--)
        {
            ...
            if (circuit_in[i].n_qubits == 2) // 2-qubit gate
            {
                IdxType qubit = circuit_in[i].qubit;
                IdxType ctrl = circuit_in[i].ctrl;
                for (IdxType j = 0; j < n_qubits; j++)
    ...
    void fuse_circuit(Circuit &circuit)
    {
        ...
        std::vector<Gate> tmp2_circuit;
        std::vector<Gate> tmp3_circuit;
