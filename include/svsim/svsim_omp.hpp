...
void C1_GATE_OMP(ValType *sv_real, ValType *sv_imag,
...
inline void C2_GATE_OMP(ValType *sv_real, ValType *sv_imag,
                        const ValType *gm_real, const ValType *gm_imag,
...
inline void C4_GATE_OMP(ValType *sv_real, ValType *sv_imag,
                        const ValType *gm_real, const ValType *gm_imag,
                        const IdxType qubit0, const IdxType qubit1,
...
void M_GATE_OMP(ValType *sv_real, ValType *sv_imag, ValType *m_real, IdxType *results,
                const IdxType qubit, const ValType rand,
                const IdxType n_qubits, const IdxType half_dim, const IdxType dim)
{
...
inline void MA_GATE_OMP(ValType *sv_real, ValType *sv_imag, ValType *m_real,
                        IdxType *results, ValType *randoms,
                        const IdxType n_qubits, const IdxType repetition)
{
...
//============== Reset ================
inline void RESET_GATE_OMP(ValType *sv_real, ValType *sv_imag, ValType *m_real,
                           const IdxType qubit, const IdxType n_qubits,
                           const IdxType half_dim, const IdxType dim)
{
    IdxType mask = ((IdxType)1 << qubit);
#pragma omp for schedule(auto)
    for (IdxType i = 0; i < ((IdxType)1 << n_qubits); i++)
