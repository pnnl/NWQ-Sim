...
// ---------------------------------------------------------------------------
// Ang Li, Senior ComPUT_AVX512er Scientist
 ...
 ***********************************************/
// Common
#define PUT_AVX512(arr, i, val) (_mm512_i64scatter_pd((arr), (i), (val), 8))
#define GET_AVX512(arr, i) (_mm512_i64gather_pd((i), (arr), 8))
#define BARR_AVX512 \
    while (0)       \
    {               \
    }
...
#define LOAD_Q0                                         \
    const __m512d el0_real = GET_AVX512(sv_real, pos0); \
    const __m512d el0_imag = GET_AVX512(sv_imag, pos0); \
    const __m512d el1_real = GET_AVX512(sv_real, pos1); \
    const __m512d el1_imag = GET_AVX512(sv_imag, pos1);
// Save 1st qubit coefficient
#define STORE_Q0                             \
    PUT_AVX512(sv_real, pos0, sv_real_pos0); \
    PUT_AVX512(sv_imag, pos0, sv_imag_pos0); \
    PUT_AVX512(sv_real, pos1, sv_real_pos1); \
    PUT_AVX512(sv_imag, pos1, sv_imag_pos1);
// Load 2nd qubit coefficient
#define LOAD_Q1                                         \
    const __m512d el2_real = GET_AVX512(sv_real, pos2); \
    const __m512d el2_imag = GET_AVX512(sv_imag, pos2); \
    const __m512d el3_real = GET_AVX512(sv_real, pos3); \
    const __m512d el3_imag = GET_AVX512(sv_imag, pos3);
// Save 2nd qubit coefficient
#define STORE_Q1                             \
    PUT_AVX512(sv_real, pos2, sv_real_pos2); \
    PUT_AVX512(sv_imag, pos2, sv_imag_pos2); \
    PUT_AVX512(sv_real, pos3, sv_real_pos3); \
    PUT_AVX512(sv_imag, pos3, sv_imag_pos3);

// macro for C2/C4 gates
#define DIV2E_AVX512(x, y) _mm512_srli_epi64((x), (y))
#define MOD2E_AVX512(x, y) _mm512_and_epi64((x), _mm512_set1_epi64(((IdxType)1 << (y)) - (IdxType)1))
#define EXP2E_AVX512(x) _mm512_set1_epi64((IdxType)1 << (x))
#define EXP2S_AVX512(x) ((IdxType)1 << (x))
#define SV4IDX_AVX512(x) _mm512_set1_epi64(((x >> 1) & 1) * EXP2S_AVX512(ctrl) + ((x & 1) * EXP2S_AVX512(qubit)))
#define SV16IDX_AVX512(x) _mm512_set1_epi64((((x) >> 3) & 1) * EXP2S_AVX512(qubit0) + (((x) >> 2) & 1) * EXP2S_AVX512(qubit1) + (((x) >> 1) & 1) * EXP2S_AVX512(qubit2) + (((x)&1) * EXP2S_AVX512(qubit3)))
// Define MG-BSP machine operation header (Optimized version)
#define OP_HEAD                                                                   \
    const __m512i cons0 = _mm512_set1_epi64((half_dim)-1);                        \
    ...
    _Pragma("omp for schedule(auto)") for (IdxType i = 0; i < (half_dim); i += 8) \
    {                                                                             \
...
#define OP_HEAD_2Q                                                                                                    \
    ...
    const __m512i base = _mm512_set_epi64(0, 1, 2, 3, 4, 5, 6, 7);                                                    \
    _Pragma("omp for schedule(auto)") for (IdxType i = 0; i < ((dim) >> 2); i += 8)                                   \
    {                                                                                                                 \
        __m512i idx = _mm512_add_epi64(_mm512_set1_epi64(i), base);                                                   \
        const __m512i term0 = MOD2E_AVX512(idx, p);                                                                   \
        const __m512i term1 = _mm512_mullo_epi64(MOD2E_AVX512(DIV2E_AVX512(idx, p), q - p - 1), EXP2E_AVX512(p + 1)); \
        const __m512i term2 = _mm512_mullo_epi64(DIV2E_AVX512(DIV2E_AVX512(idx, p), q - p - 1), EXP2E_AVX512(q + 1)); \
        const __m512i term = _mm512_add_epi64(term2, _mm512_add_epi64(term1, term0));                                 \
        __m512i pos0 = _mm512_add_epi64(term, SV4IDX_AVX512(0));                                                      \
        __m512i pos1 = _mm512_add_epi64(term, SV4IDX_AVX512(1));                                                      \
        __m512i pos2 = _mm512_add_epi64(term, SV4IDX_AVX512(2));                                                      \
        __m512i pos3 = _mm512_add_epi64(term, SV4IDX_AVX512(3));
...
//============== C1 Gate ================
void C1_GATE_AVX512(ValType *sv_real, ValType *sv_imag,
                    const ValType *gm_real, const ValType *gm_imag,
                    const IdxType qubit, const IdxType half_dim)
{
    OP_HEAD;
    LOAD_Q0;
...
inline void C2_GATE_AVX512(ValType *sv_real, ValType *sv_imag,
                           const ValType *gm_real, const ValType *gm_imag,
                           const IdxType ctrl, const IdxType qubit, const IdxType dim)
{
    OP_HEAD_2Q;
    const __m512d el0_real = GET_AVX512(sv_real, pos0);
    const __m512d el0_imag = GET_AVX512(sv_imag, pos0);
...
//#define SV16IDX_AVX512(x) _mm512_add_epi64(_mm512_add_epi64( _mm512_mullo_epi64(_mm512_and_epi64(_mm512_srli_epi64((x),3),1),EXP2E_AVX512(qubit0)),\
//_mm512_mullo_epi64(_mm512_and_epi64(_mm512_srli_epi64((x),2),1),EXP2E_AVX512(qubit1))),\
//_mm512_add_epi64( _mm512_mullo_epi64(_mm512_and_epi64(_mm512_srli_epi64((x),1),1),EXP2E_AVX512(qubit2)),\
//_mm512_mullo_epi64(_mm512_and_epi64(_mm512_srli_epi64((x),0),1),EXP2E_AVX512(qubit3))))

//============== C4 Gate ================
// Arbitrary 4-qubit gate
inline void C4_GATE_AVX512(ValType *sv_real, ValType *sv_imag,
                           const ValType *gm_real, const ValType *gm_imag,
                           ...
                           const IdxType dim)
{
    ...
    const __m512i base = _mm512_set_epi64(0, 1, 2, 3, 4, 5, 6, 7);
    _Pragma("omp for schedule(auto)") for (IdxType i = 0; i < ((dim) >> 4); i += 8)
    {
        __m512i idx = _mm512_add_epi64(_mm512_set1_epi64(i), base);
        const __m512i term0 = MOD2E_AVX512(idx, p);
        const __m512i term1 = _mm512_mullo_epi64(MOD2E_AVX512(DIV2E_AVX512(idx, p), q - p - 1), EXP2E_AVX512(p + 1));
        const __m512i term2 = _mm512_mullo_epi64(MOD2E_AVX512(DIV2E_AVX512(DIV2E_AVX512(idx, p), q - p - 1), r - q - 1), EXP2E_AVX512(q + 1));
        const __m512i term3 = _mm512_mullo_epi64(MOD2E_AVX512(DIV2E_AVX512(DIV2E_AVX512(DIV2E_AVX512(idx, p), q - p - 1), r - q - 1), s - r - 1), EXP2E_AVX512(r + 1));
        const __m512i term4 = _mm512_mullo_epi64(DIV2E_AVX512(DIV2E_AVX512(DIV2E_AVX512(DIV2E_AVX512(idx, p), q - p - 1), r - q - 1), s - r - 1), EXP2E_AVX512(s + 1));
        const __m512i term = _mm512_add_epi64(term4, _mm512_add_epi64(term3, _mm512_add_epi64(term2, _mm512_add_epi64(term1, term0))));

        const __m512d el0_real = GET_AVX512(sv_real, _mm512_add_epi64(term, SV16IDX_AVX512(0)));
        const __m512d el1_real = GET_AVX512(sv_real, _mm512_add_epi64(term, SV16IDX_AVX512(1)));
        const __m512d el2_real = GET_AVX512(sv_real, _mm512_add_epi64(term, SV16IDX_AVX512(2)));
        const __m512d el3_real = GET_AVX512(sv_real, _mm512_add_epi64(term, SV16IDX_AVX512(3)));
        const __m512d el4_real = GET_AVX512(sv_real, _mm512_add_epi64(term, SV16IDX_AVX512(4)));
        const __m512d el5_real = GET_AVX512(sv_real, _mm512_add_epi64(term, SV16IDX_AVX512(5)));
        const __m512d el6_real = GET_AVX512(sv_real, _mm512_add_epi64(term, SV16IDX_AVX512(6)));
        const __m512d el7_real = GET_AVX512(sv_real, _mm512_add_epi64(term, SV16IDX_AVX512(7)));
        const __m512d el8_real = GET_AVX512(sv_real, _mm512_add_epi64(term, SV16IDX_AVX512(8)));
        const __m512d el9_real = GET_AVX512(sv_real, _mm512_add_epi64(term, SV16IDX_AVX512(9)));
        const __m512d el10_real = GET_AVX512(sv_real, _mm512_add_epi64(term, SV16IDX_AVX512(10)));
        const __m512d el11_real = GET_AVX512(sv_real, _mm512_add_epi64(term, SV16IDX_AVX512(11)));
        const __m512d el12_real = GET_AVX512(sv_real, _mm512_add_epi64(term, SV16IDX_AVX512(12)));
        const __m512d el13_real = GET_AVX512(sv_real, _mm512_add_epi64(term, SV16IDX_AVX512(13)));
        const __m512d el14_real = GET_AVX512(sv_real, _mm512_add_epi64(term, SV16IDX_AVX512(14)));
        const __m512d el15_real = GET_AVX512(sv_real, _mm512_add_epi64(term, SV16IDX_AVX512(15)));

        const __m512d el0_imag = GET_AVX512(sv_imag, _mm512_add_epi64(term, SV16IDX_AVX512(0)));
        const __m512d el1_imag = GET_AVX512(sv_imag, _mm512_add_epi64(term, SV16IDX_AVX512(1)));
        const __m512d el2_imag = GET_AVX512(sv_imag, _mm512_add_epi64(term, SV16IDX_AVX512(2)));
        const __m512d el3_imag = GET_AVX512(sv_imag, _mm512_add_epi64(term, SV16IDX_AVX512(3)));
        const __m512d el4_imag = GET_AVX512(sv_imag, _mm512_add_epi64(term, SV16IDX_AVX512(4)));
        const __m512d el5_imag = GET_AVX512(sv_imag, _mm512_add_epi64(term, SV16IDX_AVX512(5)));
        const __m512d el6_imag = GET_AVX512(sv_imag, _mm512_add_epi64(term, SV16IDX_AVX512(6)));
        const __m512d el7_imag = GET_AVX512(sv_imag, _mm512_add_epi64(term, SV16IDX_AVX512(7)));
        const __m512d el8_imag = GET_AVX512(sv_imag, _mm512_add_epi64(term, SV16IDX_AVX512(8)));
        const __m512d el9_imag = GET_AVX512(sv_imag, _mm512_add_epi64(term, SV16IDX_AVX512(9)));
        const __m512d el10_imag = GET_AVX512(sv_imag, _mm512_add_epi64(term, SV16IDX_AVX512(10)));
        const __m512d el11_imag = GET_AVX512(sv_imag, _mm512_add_epi64(term, SV16IDX_AVX512(11)));
        const __m512d el12_imag = GET_AVX512(sv_imag, _mm512_add_epi64(term, SV16IDX_AVX512(12)));
        const __m512d el13_imag = GET_AVX512(sv_imag, _mm512_add_epi64(term, SV16IDX_AVX512(13)));
        const __m512d el14_imag = GET_AVX512(sv_imag, _mm512_add_epi64(term, SV16IDX_AVX512(14)));
        const __m512d el15_imag = GET_AVX512(sv_imag, _mm512_add_epi64(term, SV16IDX_AVX512(15)));
        ...
        for (unsigned j = 0; j < 16; j++)
        {
            ...
            PUT_AVX512(sv_real, _mm512_add_epi64(term, SV16IDX_AVX512(j)), res_real);
            PUT_AVX512(sv_imag, _mm512_add_epi64(term, SV16IDX_AVX512(j)), res_imag);
        }
    }
    BARR_AVX512;
}
