                    ...
                    if(p_shared != rows)
                    {
                        ...
                        if(i != p_shared)
                        {
                            ...
                            if(summable) 
                            {
                                ...
                                //Update the x's and z's at every column for every i row besides
                                x_arr[index] ^= x;
                                z_arr[index] ^= z;

                                //Add up all the columns in their respective rows
                        ...
                        for(int k = 0; k < half_row; k++)
                        {
                            ...
                            if(x_arr[k * cols + a])
                            {
                                ...
                                if(i == 0 && j == 0)
                                {
                                    ...
                                    row_sum_single += 2 * r_arr[k+(half_row)] + 2 * r_arr[scratch_row];
