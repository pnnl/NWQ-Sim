...
namespace NWQSim
{
    ...
    public:
        ...
        {
            //Tableau format: 2n x n X matrix, 2n x n Z matrix and 2n x 1 phase column. All have an extra 1 x n scratch space
        ...
        // {
        //     IdxType* shotCounts = new IdxType[1<<n];
        //     int singleOutcome = -1;
        ...
        void sim(std::shared_ptr<NWQSim::Circuit> circuit, double &sim_time) override
        {
            ...
            {
                printf("\n============== STAB-Sim ===============\n");
                printf("n_qubits:%d, n_gates:%lld, ncpus:%d, comp:%.3lf ms, comm:%.3lf ms, sim:%.3lf ms\n",
