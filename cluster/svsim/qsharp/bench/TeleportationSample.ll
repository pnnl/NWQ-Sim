...
@4 = internal constant [7 x i8] c", got \00"
@5 = internal constant [2 x i8] c".\00"
@6 = internal constant [26 x i8] c"Teleportation successful!\00"
@7 = internal constant [21 x i8] c"Teleportation failed\00"
@8 = internal constant [18 x i8] c"Unsupported input\00"
...
define internal void @Microsoft__Quantum__Samples__Teleportation__RunProgram__body() {
entry:
  br label %header__1

header__1:                                        ; preds = %exiting__1, %entry
  %idxRun = phi i64 [ 1, %entry ], [ %22, %exiting__1 ]
  %0 = icmp sle i64 %idxRun, 2
...
body__1:                                          ; preds = %header__1
  ...
  br i1 %sent, label %condTrue__1, label %condFalse__1

condTrue__1:                                      ; preds = %body__1
  %6 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @2, i32 0, i32 0))
  br label %condContinue__1

condFalse__1:                                     ; preds = %body__1
  %7 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @3, i32 0, i32 0))
  br label %condContinue__1

condContinue__1:                                  ; preds = %condFalse__1, %condTrue__1
  %8 = phi %String* [ %6, %condTrue__1 ], [ %7, %condFalse__1 ]
  %9 = call %String* @__quantum__rt__string_concatenate(%String* %5, %String* %8)
  ...
  br i1 %received, label %condTrue__2, label %condFalse__2

condTrue__2:                                      ; preds = %condContinue__1
  %12 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @2, i32 0, i32 0))
  br label %condContinue__2

condFalse__2:                                     ; preds = %condContinue__1
  %13 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @3, i32 0, i32 0))
  br label %condContinue__2

condContinue__2:                                  ; preds = %condFalse__2, %condTrue__2
  %14 = phi %String* [ %12, %condTrue__2 ], [ %13, %condFalse__2 ]
  ...
  %16 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @5, i32 0, i32 0))
  ...
  %18 = icmp eq i1 %sent, %received
  br i1 %18, label %condTrue__3, label %condFalse__3

condTrue__3:                                      ; preds = %condContinue__2
  %19 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @6, i32 0, i32 0))
  br label %condContinue__3

condFalse__3:                                     ; preds = %condContinue__2
  %20 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @7, i32 0, i32 0))
  br label %condContinue__3
...
exiting__1:                                       ; preds = %condContinue__3
  %22 = add i64 %idxRun, 1
  br label %header__1
...
define internal i1 @Microsoft__Quantum__Samples__Teleportation__TeleportClassicalMessage__body(i1 %message) {
entry:
...
then0__1:                                         ; preds = %entry
  call void @Microsoft__Quantum__Intrinsic__X__body(%Qubit* %msg)
...
define internal void @Microsoft__Quantum__Samples__Teleportation__Teleport__body(%Qubit* %msg, %Qubit* %target) {
entry:
  %register = call %Qubit* @__quantum__rt__qubit_allocate()
  call void @Microsoft__Quantum__Intrinsic__H__body(%Qubit* %register)
...
else__1:                                          ; preds = %condContinue__7
  %33 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @8, i32 0, i32 0))
...
else__1:                                          ; preds = %test2__1
  ...
  call void @Microsoft__Quantum__Intrinsic___53c3049d87364900b56aa68fb20929a9___QsRef36__ApplyWithLessControlsA____body(%Callable* %14, { %Array*, %Qubit* }* %16)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___645905210ecc491b80407575355d337f___QsRef36__ApplyWithLessControlsA____body(%Callable* %10, { %Array*, { %Qubit*, %Qubit* }* }* %12)
...
define internal void @Microsoft__Quantum__Intrinsic___645905210ecc491b80407575355d337f___QsRef36__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, { %Qubit*, %Qubit* }* }* %0) {
entry:
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___53c3049d87364900b56aa68fb20929a9___QsRef36__ApplyWithLessControlsA____body(%Callable* %7, { %Array*, %Qubit* }* %9)
...
define internal void @Microsoft__Quantum__Intrinsic___53c3049d87364900b56aa68fb20929a9___QsRef36__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___ef2f1dd58c34486fb28c0e171cf1559e___QsRef36__ApplyWithLessControlsA____body(%Callable* %15, { %Array*, { double, %Qubit* }* }* %17)
...
else__1:                                          ; preds = %test1__1
  ...
  call void @Microsoft__Quantum__Intrinsic___ef2f1dd58c34486fb28c0e171cf1559e___QsRef36__ApplyWithLessControlsA____body(%Callable* %16, { %Array*, { double, %Qubit* }* }* %18)
...
define internal void @Microsoft__Quantum__Intrinsic___ef2f1dd58c34486fb28c0e171cf1559e___QsRef36__ApplyWithLessControlsA____body(%Callable* %op, { %Array*, { double, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
...
else__1:                                          ; preds = %test1__1
  ...
  store %Qubit* %qubit, %Qubit** %17, align 8
  call void @Microsoft__Quantum__Intrinsic___53c3049d87364900b56aa68fb20929a9___QsRef36__ApplyWithLessControlsA____body(%Callable* %13, { %Array*, %Qubit* }* %15)
...
else__1:                                          ; preds = %test2__1
  ...
  call void @Microsoft__Quantum__Intrinsic___53c3049d87364900b56aa68fb20929a9___QsRef36__ApplyWithLessControlsA____body(%Callable* %15, { %Array*, %Qubit* }* %17)
  call void @__quantum__rt__capture_update_reference_count(%Callable* %15, i32 -1)
  call void @__quantum__rt__callable_update_reference_count(%Callable* %15, i32 -1)
  call void @__quantum__rt__array_update_reference_count(%Array* %ctls, i32 -1)
  call void @__quantum__rt__tuple_update_reference_count(%Tuple* %16, i32 -1)
...
define internal void @Microsoft__Quantum__Intrinsic___53c3049d87364900b56aa68fb20929a9___QsRef36__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, %Qubit* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, %Qubit* }, { %Array*, %Qubit* }* %0, i32 0, i32 0
...
define internal void @Microsoft__Quantum__Intrinsic___ef2f1dd58c34486fb28c0e171cf1559e___QsRef36__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, { double, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, { double, %Qubit* }* }, { %Array*, { double, %Qubit* }* }* %0, i32 0, i32 0
...
define internal void @Microsoft__Quantum__Intrinsic___645905210ecc491b80407575355d337f___QsRef36__ApplyWithLessControlsA____adj(%Callable* %op, { %Array*, { %Qubit*, %Qubit* }* }* %0) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %op, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 1)
  %1 = getelementptr inbounds { %Array*, { %Qubit*, %Qubit* }* }, { %Array*, { %Qubit*, %Qubit* }* }* %0, i32 0, i32 0
...
define void @Microsoft__Quantum__Samples__Teleportation__RunProgram__Interop() #1 {
entry:
  call void @Microsoft__Quantum__Samples__Teleportation__RunProgram__body()
  ret void
}

define void @Microsoft__Quantum__Samples__Teleportation__RunProgram() #2 {
entry:
  call void @Microsoft__Quantum__Samples__Teleportation__RunProgram__body()
