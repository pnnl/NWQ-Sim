...
bool test_Z()
{
    ...
    sim.sim();
    sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.7071,-0.7071};
    ValType sv_imag_expected[dim] = {0,0};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_S()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.7071,0};
    ValType sv_imag_expected[dim] = {0,0.7071};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_T()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.7071,0.5};
...
bool test_RI()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.6533,0.6533};
    ValType sv_imag_expected[dim] = {-0.2706,0.2706};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_RX()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.8660,0};
    ValType sv_imag_expected[dim] = {0,-0.5};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_RY()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.9659,0.2588};
    ValType sv_imag_expected[dim] = {0,0};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_RZ()
{
    ...
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.6725,0.6725};
    ValType sv_imag_expected[dim] = {-0.2185,0.2185};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_SX()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.5,0.5};
    ValType sv_imag_expected[dim] = {0.5,-0.5};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_P()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.7071,0.6371};
    ValType sv_imag_expected[dim] = {0,0.3068};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_U()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.8660,0.4045};
    ValType sv_imag_expected[dim] = {0,0.2939};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_CX()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.7071,0,0,0.7071};
...
bool test_CY()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.7071,0,0,0};
    ValType sv_imag_expected[dim] = {0,0,0,0.7071};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_CZ()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.7071,0.7071,0,0};
    ValType sv_imag_expected[dim] = {0,0,0,0};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_CH()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.7071,0.5,0,0.5};
    ValType sv_imag_expected[dim] = {0,0,0,0};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_CRI()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.7071,0.6124,0,0};
    ValType sv_imag_expected[dim] = {0,-0.3536,0,0};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_CRX()
{
    ...
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.7071,0.6124,0,0};
    ValType sv_imag_expected[dim] = {0,0,0,-0.3536};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_CRY()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.7071,0.6124,0,0.3536};
    ValType sv_imag_expected[dim] = {0,0,0,0};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_CSX()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.7071,0.3536,0,0.3536};
    ValType sv_imag_expected[dim] = {0,0.3536,0,-0.3536};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_CP()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.5,0.5,0.5,0.4045};
    ValType sv_imag_expected[dim] = {0,0,0,0.2939};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_CU()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.7071,0.6213,0,0.1330};
    ValType sv_imag_expected[dim] = {0,0.2574,0,0.1733};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_SWAP()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.7071,0,0.7071,0};
    ValType sv_imag_expected[dim] = {0,0,0,0};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_RESET()
{
    ...
    sim.sim();
    sim.print_res_sv();
    ValType sv_real_expected[dim] = {1,0};
    ValType sv_imag_expected[dim] = {0,0};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_CCX()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.5,0.5,0.5,0, 0,0,0,0.5};
    ValType sv_imag_expected[dim] = {0};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_CSWAP()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.5,0.5,0.5,0, 0,0.5,0,0};
    ValType sv_imag_expected[dim] = {0};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_U1()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.7071,0.5721};
    ValType sv_imag_expected[dim] = {0,0.4156};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_U2()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.06699,0.6079};
    ValType sv_imag_expected[dim] = {-0.25,0.7507};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
...
bool test_U3()
{
    ...
    sim.sim();
    //sim.print_res_sv();
    ValType sv_real_expected[dim] = {0.4756,0.5681};
    ValType sv_imag_expected[dim] = {-0.0948,0.6649};
    pass = check_sv(sim, sv_real_expected, sv_imag_expected);
